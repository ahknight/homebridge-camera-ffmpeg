...
module.exports = function(homebridge) {
  ...
  homebridge.registerPlatform("homebridge-camera-ffmpeg-amcrest", "Camera-ffmpeg-amcrest", ffmpegPlatform, true);
}
...
ffmpegPlatform.prototype.didFinishLaunching = function() {
  ...
  if (self.config.cameras) {
    ...
    self.api.publishCameraAccessories("Camera-ffmpeg-amcrest", configuredAccessories);
  }
}
